...
<section  id="breadcrumb">
	<div class="inner ">
		<ul>
			<li><a href="/"><img src="<?php temp_dir(); ?>/assets/images/icon_tree01.svg" alt="トップページ"></a></li>
			...
			<?php } elseif (is_tax()) { ?>
				...
				<?php endif; ?>
			<?php } elseif (is_page()) { ?>
				<?php if( $post->post_parent ): $parent_id = $post->post_parent; ?>

					<li><a href="<?php echo get_permalink($parent_id); ?>"><?php echo get_the_title($parent_id); ?></a></li>
					<li class="is-current"><?php echo get_the_title(); ?></li>
				<?php elseif( $wp_query && $wp_query->query_vars['paged'] > 1 ): ?>
